...
- (void)updateContentWithDate:(NSDate *)cellDate {
    ...
    self.monthLabel.text = [NSString stringWithFormat:@"%ld月",(long)[cellDate monthComponents]];
    self.dayLabel.text = [NSString stringWithFormat:@"%ld",(long)[cellDate dayComponents]];
